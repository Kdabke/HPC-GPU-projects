...
NN = NearestNeighbors(n_neighbors=50, radius=407, n_jobs=16) #### change radius here
NN.fit(cells[['coords_1', 'coords_2']])

X = cells[['coords_1', 'coords_2']].values
nbrs = NN.radius_neighbors(X=X, radius=407, return_distance=False, sort_results=False) #### change radius here
